...
export const CAJAS: Caja[] = [
  {
    ...
    items: [
      ...
      { nombre: "Limon",            cantidad: "1 kg",       imagen: "/images/productos/Limon.png" },
    ],
  },
  {
    id:    "caja-vegana",
    ...
    items: [
      ...
      { nombre: "Brocoli",        cantidad: "1 kg",       imagen: "/images/productos/Brocoli.png" },
      { nombre: "Pepino",         cantidad: "2 unidades", imagen: "/images/productos/Pepino.png" },
      { nombre: "Pimenton Verde", cantidad: "2 unidades", imagen: "/images/productos/PimentonVerde.png" },
      { nombre: "Zanahoria",      cantidad: "1 kg",       imagen: "/images/productos/Zanahoria.png" },
      { nombre: "Limon",          cantidad: "1 kg",       imagen: "/images/productos/Limon.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { nombre: "Brocoli",       cantidad: "1 kg",       imagen: "/images/productos/Brocoli.png" },
      { nombre: "Zanahoria",     cantidad: "1 kg",       imagen: "/images/productos/Zanahoria.png" },
      { nombre: "Platano",       cantidad: "1 kg",       imagen: "/images/productos/Platano.png" },
      { nombre: "Naranja",       cantidad: "1 kg",       imagen: "/images/productos/naranja.png" },
      { nombre: "Manzana",       cantidad: "1 kg",       imagen: "/images/productos/Manzanafuji.png" },
      { nombre: "Pimenton Rojo", cantidad: "2 unidades", imagen: "/images/productos/PimentonRojo.png" },
    ],
  },
  {
    id:    "caja-familiar",
